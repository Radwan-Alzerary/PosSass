...
router.get('/', async (req, res) => {
    try {
        ...
        const categories = await Category.find({systemId:user.systemId});
...
router.delete('/:id/comments/:commentId', async (req, res) => {
    try {
        ...
        // Pull the comment from the array of comments
        ...
        category.comments.pull(commentId);
...
router.post("/groupFoods", async (req, res) => {
    ...
    try {
        const groupedFoods = await groupFoodsByCategory(foodIds,user.systemId);
